...
MAIN_PATH=/root/my_deepspeed/applications/DeepSpeed-VisualChat/training/output/Epoch6_LR1e-3_data_ocr_vqa_all_3_2_1_1_1_1_1_1_1/
...
VISION_MODEL=/root/model_domain/clip-vit-large-patch14
LLM=/root/model_domain/Llama-2-7b-hf
...
do
    ...
    for CKPT_NAME in epoch-5
    do
    #NOTE: to run multi-GPU, you simple do "export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7;"
    export CUDA_VISIBLE_DEVICES=1; python eval/batch_generation.py --model_name dsvl --vis_proj baseline --max_seq_len 4096 \
